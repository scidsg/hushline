...
server {
        ...
        add_header Content-Security-Policy "default-src 'self'; script-src 'self' https://js.stripe.com; img-src 'self' data: https:; style-src 'self'; frame-ancestors 'none'; connect-src 'self' https://api.stripe.com; child-src https://js.stripe.com; frame-src https://js.stripe.com;";
