...
- [Getting Started](#getting-started)
  - [Step 1. Create a Hush Line Account](#step-1-create-a-hush-line-account)
  - [Step 2. Log in to Hush Line](#step-2-log-in-to-hush-line)
  - [Step 3. Add Information About Yourself](#step-3-add-information-about-yourself)
  - [Step 4. Enable End-to-End Encryption](#step-4-enable-end-to-end-encryption)
  - [Step 5. Enable Message Forwarding](#step-5-enable-message-forwarding)
- [Secure Your Account](#secure-your-account)
  - [Step 1. Enable Two-Factor Authentication](#step-1-enable-two-factor-authentication)
  - [Step 2. Scan the QR Code](#step-2-scan-the-qr-code)
  - [Step 3. Log In Again](#step-3-log-in-again)
- [Share Your Tip Line (Account Visibility)](#share-your-tip-line-account-visibility)
  - [Step 1. Make Yourself Discoverable](#step-1-make-yourself-discoverable)
  - [Step 2. Share Your Address Widely](#step-2-share-your-address-widely)
- [Message Replies](#message-replies)
  - [Step 1. Set Custom Replies](#step-1-set-custom-replies)
  - [Step 2. Send Yourself a Test Message](#step-2-send-yourself-a-test-message)
  - [Step 3. Set a Status](#step-3-set-a-status)
- [Account Verification](#account-verification)
  - [Step 1. Add a Display Name](#step-1-add-a-display-name)
  - [Step 2. Include Additional URLs](#step-2-include-additional-urls)
  - [Step 3. Contact Us](#step-3-contact-us)
- [Best Practices](#best-practices)
  - [Recommendation 1. Add an Encryption Key](#recommendation-1-add-an-encryption-key)
  - [Recommendation 2. Add a Rich Bio](#recommendation-2-add-a-rich-bio)
- [For Whistleblowers](#for-whistleblowers)
  - [Step 1. Start With The Directory](#step-1-start-with-the-directory)
  - [Step 2. Submit Your Message](#step-2-submit-your-message)
  - [Step 3. Wait For A Response](#step-3-wait-for-a-response)
