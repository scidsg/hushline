...
| 7   | Is it a feature with no auth/env/security impact and a tested rollback plan?             | Medium              | AI-First       | Engineer   | AI can generate migration scripts and test plans under human engineer oversight       | Any migration that could affect data integrity, availability, or rollback safety                              | Human engineer must review, test, and execute migrations in production    |
