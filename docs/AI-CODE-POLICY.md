...
| 7   | Is it a feature with no DB/auth/env/security impact and a tested rollback plan?          | Medium              | AI-First       | Engineer                  | AI can draft implementation and tests with engineer oversight                         | Scope expands to DB/auth/env/security, or rollback plan is incomplete                                         | AI-assisted implementation, human engineer approves and deploys           |
| 8   | Is it a DB migration (schema/data/index) even without auth/env/security impact?          | High                | Human-First    | Engineer                  | AI can draft migration scripts and rollback plans under human oversight               | Any migration that could affect data integrity, availability, or rollback safety                              | Human engineer must review, test, and execute migrations in production    |
| 9   | Is it a large feature or refactor?                                                       | High                | Human-First    | Engineer                  | AI optional, only with human engineer oversight                                       | Any broad change spanning multiple systems or high regression risk                                            | Human engineer owns design, rollout plan, and release                     |
...
| 11  | Is it documentation like this matrix (policy/process docs)?                              | Low                 | AI-First       | Any                       | Strong fit for drafting, editing, and formatting with human review                    | Docs define policy, legal/compliance positions, or external commitments                                       | AI drafts, human owner approves final language                            |
