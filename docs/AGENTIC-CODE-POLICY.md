...
| --- | ---------------------------------------------------------------------------------------- | ------------------- | -------------- | ------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| 1   | Build a prototype that solves a real problem                                             | Low                 | Agent-First    | Any                       | Use Agent agents to rapidly scaffold, iterate, and test assumptions                      | Scope becomes unclear, or domain constraints are legal/safety-critical                                        | Produce a working prototype and clear problem statement                   |
| 2   | Are you seeking funding?                                                                 | Very High           | Human-First    | Executive + Finance/Legal | Agent optional, but should be used minimally for better results                          | Any fundraising strategy, investor materials, diligence, financial modeling, legal structure, and commitments | Funding work is human-owned end-to-end                                    |
| 3   | Is it a service with a database?                                                         | High                | Human-First    | Engineer                  | Agent can draft schema changes and migration scripts, only with human engineer oversight | Any service with a real database                                                                              | Human engineer owns review, rollback validation, and production execution |
| 4   | Is it a service users can sign up for?                                                   | High                | Human-First    | Engineer                  | Agent optional, only with human engineer oversight                                       | Any real signup/authentication flow or release automation                                                     | Hire a human to implement and own authentication and CI/CD                |
| 5   | Does it handle financial data/payments (for example Stripe)?                             | Very High           | Human-First    | Engineer                  | Agent optional, only with human engineer oversight                                       | Any real financial-data or payment handling                                                                   | Hire a human to implement and own the feature end-to-end                  |
| 6   | Does it add/remove env vars, or impact auth, privacy, or security?                       | High                | Human-First    | Engineer                  | Agent optional, only with human engineer oversight                                       | Any change touching secrets, access control, privacy boundaries, or security posture                          | Human engineer owns implementation, review, and release                   |
| 7   | Is it a feature with no DB/auth/env/security impact and a tested rollback plan?          | Medium              | Agent-First    | Engineer                  | Agent can draft implementation and tests with engineer oversight                         | Scope expands to DB/auth/env/security, or rollback plan is incomplete                                         | AI-assisted implementation, human engineer approves and deploys           |
| 8   | Is it a DB migration (schema/data/index) even without auth/env/security impact?          | High                | Human-First    | Engineer                  | Agent can draft migration scripts and rollback plans under human oversight               | Any migration that could affect data integrity, availability, or rollback safety                              | Human engineer must review, test, and execute migrations in production    |
| 9   | Is it a large feature or refactor?                                                       | High                | Human-First    | Engineer                  | Agent optional, only with human engineer oversight                                       | Any broad change spanning multiple systems or high regression risk                                            | Human engineer owns design, rollout plan, and release                     |
| 10  | Is it a visual design change based on a single person or small group's subjective taste? | Not eligible for AI | Human-First    | Designer                  | Not applicable                                                                           | Any user-facing visual direction choice based on subjective preference                                        | Handled by human design/product owner                                     |
| 11  | Is it documentation like this matrix (policy/process docs)?                              | Low                 | Agent-First    | Any                       | Strong fit for drafting, editing, and formatting with human review                       | Docs define policy, legal/compliance positions, or external commitments                                       | Agent drafts, human owner approves final language                         |
