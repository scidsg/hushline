...
| OH    | Supreme Court of Ohio attorney directory (`supremecourt.ohio.gov`)             | Official search flow -> resolve exact result URL | Adapter scaffolded       |
...
| TN    | Tennessee Board of Professional Responsibility attorney records (`tbpr.org`)   | Official search flow -> resolve exact result URL | Adapter scaffolded       |
