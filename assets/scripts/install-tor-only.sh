...
<body class="info">
    ...
    <section>
        <div class="wrapper">
            ...
            <p>To use Hush Line, first, <a href="https://www.torproject.org/download/" target="_blank">download Tor Browser</a>, then use it to visit: <pre>http://$ONION_ADDRESS</pre>.</p>
        </div>
    </section>
