/******/ (() => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    function normalizedCountryFilterValue(value) {
      ...
      return (
        legacyCountryNameByCode[normalizedValue.toLowerCase()] ||
        normalizedValue
      );
    }
    ...
    function updateTabScrollControls() {
      ...
      const hasOverflow =
        desktopTabScrollMediaQuery.matches && overflowWidth > 1;
    ...
    function createLocationFilterController(config) {
      ...
      controller.updateToggle = function () {
        ...
        const toggleLabel = controller.toggle.querySelector(
          "[data-filter-toggle-label]",
        );
        const toggleBadge = controller.toggle.querySelector(
          "[data-filter-toggle-badge]",
        );
      ...
      controller.updateListingTypeLabels = function () {
        ...
        controller.listingTypeFilter.innerHTML =
      ...
      controller.updateRegionOptions = function () {
        ...
        if (
          !availableRegions.some((region) => region.code === selectedRegion)
        ) {
